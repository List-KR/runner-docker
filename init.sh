...
# npm packages
NpmPackages=("@actions/core" "@actions/github" "@actions/exec" "selenium-webdriver" "node-json-db" "ts-node" "tslib" "typescript" "adm-zip" "chance" "safe-regex" "benchmark" "openpgp" "sha.js" "regexp-tree" "husky")
